...
CREATE DATABASE `skoly` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `skoly`;
...
DROP TABLE IF EXISTS `pocet_prijatych`;
...
(1,	'aristoteles',	'haha'),
(2,	'panpanpan',	'$2y$10$rsBRVcUXYZir5kdCg5B0s./tCBBs6cEeotYKxq6ZlSGwX3dTAb1PO'),
(3,	'petr',	'$2y$10$7qq.6WPAZdmxMuPG34oQZu/Q.G3Y48NVxmJe67QYTc8kCrBJMiuK2'),
(4,	'tester',	'$2y$10$ojjuSTJJYu0w9M9x2tPq8eLxSxh3lkWuMik5U/NbIu20qeMDNFb3O'),
(5,	'test',	'$2y$10$UEl92llhKynQfBJjhL3i/esL7V08p/nkN4CHBxG4iKUHLj4S4JDNC'),
(6,	'testerr',	'$2y$10$PH9Em7BJj2lO5yW6Mp2/JucT2DEA8eWVrUNhLMNY22TIDhnP8xPtC');

DROP TABLE IF EXISTS `zpetna_vazba`;
